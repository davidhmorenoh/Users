package com.management.users.application.dtos.requests.update;

import com.management.users.application.validation.ValidUUIDSize;
...
@Getter
@Setter
public class PhoneUpdateRequest implements Serializable {
